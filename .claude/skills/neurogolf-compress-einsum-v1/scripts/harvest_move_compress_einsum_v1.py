#!/usr/bin/env python3
"""Move downloaded ONNX into claude-for-chrome-compress-einsum-v1/{label}/ and log.

Use snapshot-diff so shared ~/Downloads files are not touched.

Usage:
  python harvest_move_compress_einsum_v1.py snap
  python harvest_move_compress_einsum_v1.py move <task_num> <session_id> <label1> [label2 ...]
...
SNAP = "/tmp/harvest_compress_einsum_v1_snap.txt"
DL = os.path.expanduser("~/Downloads")
BASE = os.path.expanduser("~/Documents/NeuroGolf-2026/claude-for-chrome-compress-einsum-v1")
MAN = os.path.expanduser(
    "~/Documents/NeuroGolf-2026/zzz_sessions/onnx-harvest-manifest-compress-einsum-v1.csv"
)
