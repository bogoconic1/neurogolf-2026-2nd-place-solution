...
STATE = os.path.expanduser(
    "~/Documents/NeuroGolf-2026/auto_submit_onnx_state_claude_for_chrome_compress_einsum_v1.json"
)
MAN = os.path.expanduser(
    "~/Documents/NeuroGolf-2026/zzz_sessions/onnx-harvest-manifest-compress-einsum-v1.csv"
)
LOGS = [
    os.path.expanduser(f"~/Documents/NeuroGolf-2026/zzz_sessions/compress-einsum-v1-submit-{k}.log")
