#!/usr/bin/env python3
"""Move downloaded ONNX into claude-for-chrome-convert-to-0m-einsum-v1/{label}/ and log.

Use snapshot-diff so shared ~/Downloads files are not touched.

Usage:
  python harvest_move_convert_to_0m_einsum_v1.py snap
  python harvest_move_convert_to_0m_einsum_v1.py move <task_num> <session_id> <label1> [label2 ...]
...
SNAP = "/tmp/harvest_convert_to_0m_einsum_v1_snap.txt"
