#!/usr/bin/env python3
"""Reconcile NeuroGolf convert-to-0m-einsum-v1 ONNX submissions by HF Space verdict.

Usage:
  python reconcile_submissions_convert_to_0m_einsum_v1.py --dry-run
  python reconcile_submissions_convert_to_0m_einsum_v1.py --apply
"""
import csv
import glob
import hashlib
