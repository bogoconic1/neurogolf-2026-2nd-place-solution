#!/usr/bin/env python3
"""Reconcile NeuroGolf cost-golf-v1 ONNX submissions by HF Space verdict.

Usage:
  python reconcile_submissions_cost_golf_v1.py --dry-run
  python reconcile_submissions_cost_golf_v1.py --apply
"""
import csv
import glob
import hashlib
...
STATE = f"{ROOT}/auto_submit_onnx_state_claude_for_chrome_cost_golf_v1.json"
MAN = f"{ROOT}/zzz_sessions/onnx-harvest-manifest-cost-golf-v1.csv"
LOGS = [
    f"{ROOT}/zzz_sessions/cost-golf-v1-submit-{k}.log" for k in ("safe", "unsafe")
]
