#!/usr/bin/env python3
"""Move downloaded markdown write-ups into claude-for-chrome-runtime-v1-markdown/.

Use snapshot-diff so shared ~/Downloads files are not touched.

Usage:
  python harvest_move_md_runtime_v1.py snap
  python harvest_move_md_runtime_v1.py move <task_num> <session_id>
"""
import glob
import os
import shutil
...
SNAP = "/tmp/harvest_md_runtime_v1_snap.txt"
DL = os.path.expanduser("~/Downloads")
BASE = os.path.expanduser("~/Documents/NeuroGolf-2026/claude-for-chrome-runtime-v1-markdown")
MAN = os.path.expanduser(
    "~/Documents/NeuroGolf-2026/zzz_sessions/markdown-harvest-manifest-runtime-v1.csv"
)
