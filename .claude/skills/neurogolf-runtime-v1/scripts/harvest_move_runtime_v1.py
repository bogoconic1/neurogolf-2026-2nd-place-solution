#!/usr/bin/env python3
"""Move downloaded ONNX into claude-for-chrome-runtime-v1/{label}/ and log.

Use snapshot-diff so shared ~/Downloads files are not touched.

Usage:
  python harvest_move_runtime_v1.py snap
  python harvest_move_runtime_v1.py move <task_num> <session_id> <label1> [label2 ...]
