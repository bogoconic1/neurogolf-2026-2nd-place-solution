...
TASK_ID = 'task271'
TASK_NUM = 271
KAGGLE = {'score': 21.149852, 'date': '2026-07-11'}
MEMORY_BYTES = 36
PARAMS = 11
...
DOMAIN = ''
MODEL_VERSION = 0
GRAPH_NAME = 'task271_rng_shrink'
OPSETS = [('', 15)]


# p: FLOAT[1, 1, 1, 1], 1 value(s)
INIT_P_0 = [0.28999999165534973]

# w: INT8[10, 1, 1, 1], 10 value(s)
INIT_W_1 = [0, -1, 0, 0, 0, 0, 0, 0, 1, 0]
...
def make_onnx() -> onnx.ModelProto:
    nodes = [
        ...
        # 14: ConvInteger inputs=2 outputs=1
        _node(
            'ConvInteger',
            ['sg', 'w'],
            ['output'],
