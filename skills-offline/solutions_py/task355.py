...
TASK_ID = 'task355'
TASK_NUM = 355
KAGGLE = {'score': 22.004268, 'date': '2026-07-11'}
MEMORY_BYTES = 19
PARAMS = 1
...
DOMAIN = ''
MODEL_VERSION = 0
GRAPH_NAME = 'task355_rng_sharedp_pair'
OPSETS = [('', 15)]


# p: DOUBLE[1, 1, 1, 1], 1 value(s)
INIT_P_0 = [0.5469798422475534]
